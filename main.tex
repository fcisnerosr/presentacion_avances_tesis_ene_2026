...
% Slide 3: Metodología Propuesta (1/2)
\begin{frame}{Metodología Propuesta (1/2)}
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textheight, keepaspectratio]{005_metogologia_propuesta_para_identificar_daños_en_plataformas_reales.jpg}
        \vspace{0.2cm}
        \small{Flujo de identificación en plataformas reales.}
        
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textheight, keepaspectratio]{006_metodología_del_AG_para_localizar_daños_a_nivel_computacional.jpg}
        \vspace{0.2cm}
        \small{Esquema computacional del AG.}
    \end{columns}
\end{frame}

% Slide 4: Metodología Propuesta (2/2)
\begin{frame}{Metodología Propuesta (2/2): El Algoritmo Genético}
    \centering
    \includegraphics[width=0.9\textwidth, height=0.75\textheight, keepaspectratio]{015_diagrama_como_funciona_el_AG_para_la_sumas_funcion_P_y_como_se_relaciona_con_operadores_geneticos_del_AG.jpg}
...
\begin{frame}{Caso de Estudio: Plataforma Tipo Jacket}
    ...
    \begin{columns}
        ...
        \centering
        \includegraphics[width=\textwidth, height=0.55\textheight, keepaspectratio]{007_modelo_vista_fronta_de_plataforma_tipo_jacket_de_caso_de_estudio.png}
        \tiny{Vista Frontal}
        
        \column{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.55\textheight, keepaspectratio]{007_modeo_vista_3d_de_plataforma_tipo_jacket_de_caso_de_estudio.png}
        \tiny{Vista 3D}
        
        \column{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.55\textheight, keepaspectratio]{007_modeo_vista_3d_de_plataforma_tipo_jacket_de_caso_de_estudio_pero_con_colores_para_saber_que_secciones_transversales_estan_ubicados_con_una_tabla.png}
        \tiny{Secciones Transversales}
    \end{columns}
\end{frame}

% Slide 6: Modelado de Daño - Abolladura
\begin{frame}{Modelado de Daño: Abolladura}
    \textbf{Enfoque:} Reducción de rigidez localizada en elementos viga (validado en literatura).
    \vspace{0.3cm}
...
\begin{frame}{Modelado de Daño: Corrosión}
    \textbf{Enfoque:} Corrosión Uniforme por zonas (Splash Zone vs. Sumergida) como proxy de degradación de rigidez.
    \vspace{0.3cm}
...
% Slide 10: Resultados - Abolladura
\begin{frame}{Resultados: Detección de Abolladura}
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{005_abolladura_comparativa_global_de_ICD_vs_daño_por_zona_mudline_medio_y_splash_zone.png}
        \small{Comparativa Global ICD vs Daño}
        
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{006_abolladura_ICD_por_zona_desglozadp_por_tipo_de_elemento_desde_mudline_medio_y_splash_zone.png}
        \small{Desglose por Zona y Tipo de Elemento}
    \end{columns}
\end{frame}

% Slide 11: Resultados - Corrosión
\begin{frame}{Resultados: Detección de Corrosión}
    \begin{columns}
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{005_corrosion_comparativa_global_de_ICD_vs_daño_por_zona_mudline_medio_y_splash_zone.png}
        \small{Comparativa Global ICD vs Corrosión}
        
        \column{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{006_corrosion_ICD_por_zona_desglozadp_por_tipo_de_elemento_desde_mudline_medio_y_splash_zone.png}
        \small{Desglose por Zona}
    \end{columns}
\end{frame}
