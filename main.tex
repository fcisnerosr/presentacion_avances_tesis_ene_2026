...
\begin{frame}{Desglose de Ejecuciones: Caso de Abolladura}
    \centering
    
    \textbf{Desglose del número total de ejecuciones del AG para Abolladura:}
    
    \vspace{0.5cm}
    
    \begin{equation*}
        \text{Total de ejecuciones} = 120 \, \text{elementos} \times 10 \, \text{niveles de daño} = 1200
    \end{equation*}
    ...
    \begin{gather*}
        \text{Niveles de daño} = \{5\%, 10\%, 15\%, \dots, 50\%\} \\
        \Rightarrow 10 \, \text{niveles en incrementos de } 5\%
    \end{gather*}
\end{frame}

\begin{frame}[t]{Resultados Anteriores}
\subsection{Corrosión}
    \vspace*{-1.5cm}
    \begin{columns}[t]
        \begin{column}{0.7\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth, height=0.75\textheight, keepaspectratio]{./figs/017_resultados_anteriores.png}
                \caption{Visualización de resultados anteriores de corrosión.}
            \end{figure}
        \end{column}
        \begin{column}{0.3\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth, keepaspectratio]{"./figs/018_modelo_de_resultados anteriores.png"}
                \caption{\footnotesize Modelo de referencia}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
